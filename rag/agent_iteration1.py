...
from rag.tools.cypher import cypher_qa
import pandas as pd
...
tools = [
    ...
    Tool.from_function(
        ...
        description="Stellt Informationen zur Schweizer Politik insbesondere Politiker und Institutionen mit Vektorsuche zur Verfügung",
        func = run_retriever,
        return_direct=False,
...
#RAG-prompt for langchain agent
...
When one tool does not lead to an answert ALWAYS try the other tools.
...
def generate_response_list(prompts):
